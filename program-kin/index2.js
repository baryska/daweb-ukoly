...
const renderMovie = (movie) => {                // parametr movie je náhodně vybraný - bude zastoupen objektem, který zadáme při volání funkce (cinema1.movies[0])
  const tempElm = document.createElement('div')
